...
public:
	...
	bool DeleteSubFile();
	bool CopyingFolder(FolderType*& data, std::string name);
	bool CopyingFile(FileType*& data, std::string name);
	bool PastingFolder(FolderType*& data);
	bool PastingFile(FileType*& data);
	bool RetrieveFolderByName(std::string name);
	bool RetrieveFolderByName(const FolderType*& data);
	bool RetrieveFileByName(std::string name);
	bool RetrieveFileByName(const FileType*& data);
